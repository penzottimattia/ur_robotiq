...
def generate_launch_description():
    args = [
        ...
        DeclareLaunchArgument('reference_frame_post', default_value=''),
        DeclareLaunchArgument('manipulated_frame', default_value='manipulated_object'),
        DeclareLaunchArgument('manipulated_frame_post', default_value=''),
        DeclareLaunchArgument('depth_post', default_value='0.0'),
    ...
    node = Node(
        ...
        parameters=[{
            ...
            'reference_frame_post': LaunchConfiguration('reference_frame_post'),
            'manipulated_frame': LaunchConfiguration('manipulated_frame'),
            'manipulated_frame_post': LaunchConfiguration('manipulated_frame_post'),
            'depth_post': LaunchConfiguration('depth_post'),
